...
export const InventoryScreen = () => {
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <PlaceholderScreen lessonLink="a-well-stocked-station" sourceFile="src/stage-03/InventoryScreen.jsx " demoSourceFile="src/completed-app/inventory/Inventory.jsx" demoRoute="DemoAppInventory" />
